...
//   GuiNewChat / ChatComponentText -> ChatComponent / net.minecraft.network.chat.Component
//   I18n.format               -> net.minecraft.client.resources.language.I18n.get
//   PlayerControllerMP + GameType reflection -> MultiPlayerGameMode#getPlayerMode().getId()
