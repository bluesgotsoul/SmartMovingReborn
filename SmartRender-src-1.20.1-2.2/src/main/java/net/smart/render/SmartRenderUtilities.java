...
//
// Pure-math base class (no Minecraft API). Ported verbatim from 1.8.9: it only holds the
// shared angle constants and the angle helpers used across the render bone hierarchy
// (ModelRotationRenderer) and the smart models (SmartRenderModel / SmartRenderRender via
// SmartRenderContext). Nothing here changed between versions.
// ------------------------------------------------------------------
